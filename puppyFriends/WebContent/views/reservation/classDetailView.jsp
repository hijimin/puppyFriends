	...
	<div class="outer">
        ...
        <div class="photo_text"> <!-- 왼쪽 맵-->
            ...
            <div class="text" align="right"> <!-- 오른쪽 맵 -->
                ...
                <div class="btn_bar1">
                	<a href="<%= contextPath %>/hotel.hrv" class="C_back">뒤로가기</a> <br>
                </div>

				<% if(loginUser != null && loginUser.getMemberId().equals("ADMIN")) { %>
                <div class="btn_bar1">
                <a href="#" onclick="confirmDelete('<%= h.getHotelNo() %>')" class="C_delete">삭제하기</a>
                </div>
                <% } %>
            </div>
			...
			function confirmDelete(hotelNo) {
			    ...
			    if (result) {
			        window.location.href = "<%= contextPath %>/delete.crv?num=" + hotelNo;
			    }else{
			    	alert("삭제가 취소되었습니다.");
			    }
			}
