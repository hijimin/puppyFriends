...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<% 
	ArrayList<KinderClass> list = (ArrayList<KinderClass>)request.getAttribute("list");
...
<body>
	...
	<form action="<%= contextPath %>/kinderClass.crv" id="classmain-form"
    ...
    <div class="outer">
        ...
        <div class="list-area">
            <div class="list-area-thum">
                <div class="thum_tool">
                    <% for(KinderClass c : list){ %>
                        <div class="thumbnail">
                                <input type="hidden" name="cno" value="<%= c.getClassNo() %>">
                                    <img src="<%= contextPath %>/<%= c.getTitleImg() %> " width="230px" height="200px" style="border-radius: 5%; "> <br>
                                    <div>
                                        유치원명 : <%= c.getClassName() %> <br> 
                                        전용 사이즈 : <%= c.getClassSize() %> <br>
                                    </div>
                        </div>
                    <% } %>
                </div>
            ...
            <div class="btn_bar">
      		 <% if(loginUser != null && (loginUser.getMemberId().equals("ADMIN"))) {%>
        	    <a href="<%= contextPath %>/enrollForm.crv" class="C_enroll">등록하기</a>
        	 <% } %>
            </div>
	...
	$(function(){
		$(".thumbnail").click(function(){
			location.href="<%= contextPath %>/detail.crv?cno=" + $(this).children("input").val();
		})
	})
