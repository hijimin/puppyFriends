...
public class Reservation {
	...
	public Reservation(int reservationNo, int memberNo, int facilityNo, Date reservationDate, int price,
			int paymentNo) {
		super();
	...
	public String toString() {
		return "Reservation [reservationNo=" + reservationNo + ", memberNo=" + memberNo + ", facilityNo=" + facilityNo
				+ ", reservationDate=" + reservationDate + ", price=" + price + ", paymentNo=" + paymentNo + "]";
	}
